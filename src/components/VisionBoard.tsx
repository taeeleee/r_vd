    ...
    <div className="flex flex-col h-[calc(100vh-80px)] bg-background">
      ...
      <main className="flex-1 p-4 relative overflow-hidden">
        <div className="h-full rounded-2xl bg-white/60 backdrop-blur-lg border border-white/30 shadow-glass relative overflow-hidden">
          ...
          <Button 
            className="absolute bottom-40 right-4 h-10 w-10 rounded-full bg-primary/90 backdrop-blur-lg border border-white/20 shadow-glass hover:shadow-xl transition-all duration-300 hover:scale-105"
            size="icon"
